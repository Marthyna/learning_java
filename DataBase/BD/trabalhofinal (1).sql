...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Mar-2018 às 14:40
...
INSERT INTO `cidade` (`cidade_id`, `nome`, `estado_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `estado` (`estado_id`, `nome`, `uf`, `pais_id`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
INSERT INTO `pais` (`pais_id`, `nome`, `sigla`) VALUES
(1, 'Brasil', 'BR');
...
ALTER TABLE `cidade`
  ...
  ADD KEY `estado_id_fk` (`estado_id`);
...
ALTER TABLE `contrato`
  ...
  ADD KEY `imovel_id_fk` (`imovel_id`),
  ADD KEY `locatario_id_fk` (`locatario_id`),
  ADD KEY `locador_id_fk` (`locador_id`);
...
ALTER TABLE `estado`
  ...
  ADD KEY `pais_id_fk` (`pais_id`);

--
-- Indexes for table `imobiliaria`
--
ALTER TABLE `imobiliaria`
  ADD PRIMARY KEY (`imobiliaria_id`),
  ADD KEY `locatario_id_fk` (`locatario_id`);
...
ALTER TABLE `imovel`
  ...
  ADD KEY `cidade_id_fk` (`cidade_id`);

--
-- Indexes for table `locador`
--
ALTER TABLE `locador`
  ADD PRIMARY KEY (`locador_id`),
  ADD KEY `cidade_id_fk` (`cidade_id`);
...
--
ALTER TABLE `locador`
  MODIFY `locador_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `locatario`
--
ALTER TABLE `locatario`
  MODIFY `locatario_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pessoa_fisica`
  MODIFY `pessoaf_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pessoa_juridica`
--
ALTER TABLE `pessoa_juridica`
  MODIFY `pessoaj_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `estado_id_fk` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `contrato`
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `imovel_id_fk` FOREIGN KEY (`imovel_id`) REFERENCES `imovel` (`imovel_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `locador_id_fk` FOREIGN KEY (`locador_id`) REFERENCES `locador` (`locador_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `locatario_id_fk3` FOREIGN KEY (`locatario_id`) REFERENCES `locatario` (`locatario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `estado`
--
ALTER TABLE `estado`
  ADD CONSTRAINT `pais_id_fk` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`pais_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `imobiliaria`
--
ALTER TABLE `imobiliaria`
  ADD CONSTRAINT `locatario_id_fk2` FOREIGN KEY (`locatario_id`) REFERENCES `locatario` (`locatario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `imovel`
--
ALTER TABLE `imovel`
  ADD CONSTRAINT `cidade_id_fk3` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`cidade_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `locador`
--
ALTER TABLE `locador`
  ADD CONSTRAINT `cidade_id_fk2` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`cidade_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `locatario`
--
ALTER TABLE `locatario`
  ADD CONSTRAINT `cidade_id_fk` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`cidade_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `pessoa_fisica`
--
ALTER TABLE `pessoa_fisica`
  ADD CONSTRAINT `locatario_id_fk` FOREIGN KEY (`locatario_id`) REFERENCES `locatario` (`locatario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `pessoa_juridica`
--
ALTER TABLE `pessoa_juridica`
  ADD CONSTRAINT `locatario_id_fk_3` FOREIGN KEY (`locatario_id`) REFERENCES `locatario` (`locatario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
